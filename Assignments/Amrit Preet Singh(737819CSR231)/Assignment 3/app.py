...
COS_API_KEY_ID = "OlqPoCEDERNr-7z-pK6GTboNb8-KdcE0P1Btd4_5CLot"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/cbcb6c048e12455e8f6826b478b949be::serviceid:ServiceId-a47571cc-6f0d-4b48-9486-21b4d94dacf9"
...
@app.route('/')
def index():
    files = get_bucket_contents('addingimages')
